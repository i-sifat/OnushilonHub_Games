<p align="center">
  <img src="https://raw.githubusercontent.com/i-sifat/OnushilonHub_Games/main/assets/logo.png" width="120" alt="OnushilonHub Logo">
</p>
...
> 💡 **For Google Play Store:** Download the `.aab` bundle from releases if you're a distributor.
...
│   ├── app/
│   │   └── build.gradle.kts   # Build & signing config
│   └── key.properties    # Signing credentials (local only)
...
|---------|--------|--------|
| `push` to `main` | Auto-build & bump version | Continuous prerelease |
| `push` tag `v*.*.*` | Build, sign & publish | Stable GitHub Release |
| `workflow_dispatch` | Manual build on demand | Custom release |

**Every release includes:**
- ✅ Signed APK (direct install)
- ✅ Signed AAB (Google Play Store ready)
...
- Inspired by the spirit of *Onushilon* (অনুশীলন) — the Bengali word for practice and learning
