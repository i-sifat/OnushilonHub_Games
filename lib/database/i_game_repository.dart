...
import 'game_data_repository.dart'
    show ResolvedSynonymAntonymQuestion, ResolvedWhoseQuoteQuestion, EraModel;
...
abstract class IGameRepository {
  ...
  Future<List<String>> getSynonymDistractorPool({required int limit});
  ...
  Future<List<String>> getAntonymDistractorPool({required int limit});
  ...
  Future<List<dynamic>> getMeaningChasePhrases({required int limit});
